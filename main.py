...
#pyrytiles.compile_primary(path="Test/EmeraldGeneral/Decompiled",out_dir="Test/EmeraldGeneral/RecompiledTriple",optimal=False, triple_layer=True)
#pyrytiles.compile_secondary(path="Test/Slateport/DecompiledEmeraldOriginal",out_dir="Test/Slateport/RecompiledTriple",path_primary="Test/EmeraldGeneral/RecompiledTriple",optimal=False, triple_layer=True)
