...
#compile_secondary(path="Test/Pacifidlog/DecompiledEmeraldOriginal",out_dir="Test/Pacifidlog/RecompiledTriple",path_primary="Test/EmeraldGeneral/RecompiledTriple",optimal=False,triple_layer=True)
