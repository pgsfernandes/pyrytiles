...
- **Game Profiles**: Supports `pokeemerald`-style limits by default and FireRed limits with `game="firered"`. Emerald uses 512 primary tiles, 512 secondary tiles, 6 primary palettes, and 6 secondary palettes. FireRed uses 640 primary tiles, 384 secondary tiles, 7 primary palettes, and 5 secondary palettes.
...
compile_primary(
    ...
    game="emerald" # Use "firered" for FireRed tileset limits
)
```
